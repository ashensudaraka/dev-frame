...
class _EditTenantState extends State<EditTenant> {
  ...
  void initState() {
    ...
    nameController.text = widget.tenantName;
    customerNameController.text = widget.customerName;
    noOfTotalUsersController.text = widget.noOfTotalUsers;
    expiryDateController.text = widget.validUntil;
    statusController.text = widget.status;
    adminNameController.text = widget.name;
    adminEmailController.text = widget.email;
    adminUsernameController.text = widget.userName;
    adminPasswordController.text = widget.password;
    adminConfirmPasswordController.text = widget.password;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          DevFrameLocalization.of(context).editTenantPageTitle +
              ' - ' +
              widget.tenantName,
          style:
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                ListTile(
                  leading: FormLabel(
                    text: DevFrameLocalization.of(context).confirmPasswordText,
                    useMobileLayout: isMobileLayout(context),
                  ),
                  title: textField.TextField(
        ...
        if (snapshot.hasData) {
          switch (snapshot.data.status) {
            ...
            case Status.COMPLETED:
              print('NEW TENANT HAS BEEN UPDATED');
            ...
            case Status.ERROR:
              return Text(
                ...
                style: TextStyle(
                    ...
                    fontSize: getTextSize('useMobileSize'),
...
showSuccessAlertDialog(BuildContext context) async {
  ...
  AlertDialog alert = AlertDialog(
    ...
    content: Text(DevFrameLocalization.of(context).tenantUpdateSuccess),
    actions: [
      okButton,
    ],
  );
